...
public final class PopularMoviesWeatherUtils {
    private static final String LOG_TAG = PopularMoviesWeatherUtils.class.getSimpleName();
    ...
    public static String formatTemperature(Context context, double temperature) {
        ...
        if (!PopularMoviesPreference.isMetric(context)) {
